...
def ensembleEverything(typeOp,balanced):
	...
	features = [train_data_features_ngrams, train_data_features_ngrams, train_data_features_ngrams,train_data_features_ngrams]
	eclf1 = VotingClassifier(estimators=[('bayes', bayes), ('randomForest', forest), ('svm', svm), ('sgd', sgd)], voting='soft')
